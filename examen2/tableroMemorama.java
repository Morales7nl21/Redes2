 ...
 * @author LENOVO 720
 */
public class tableroMemorama extends javax.swing.JFrame {

    /**
     * Creates new form tableroMemorama
     */
    private boolean azar = false;
    public ImageIcon atras = null;

    public tableroMemorama(boolean azar, String ruta) {
        JOptionPane.showMessageDialog(null, ruta + "//imagen0.jpg");
        this.atras = new ImageIcon(ruta + "//imagen0.jpg");

        this.azar = azar;
        initComponents();
    }

    private tableroMemorama() {
        initComponents();
    }

    public void establecerFondo() {
        this.setResizable(true);
        jButton1.setBounds(jButton1.getWidth(),jButton1.getHeight(), 60, 70);
        Icon icono = new ImageIcon(atras.getImage().getScaledInstance(jButton1.getWidth()+10, jButton1.getHeight()+10, Image.SCALE_SMOOTH));                
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tableroMemorama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tableroMemorama().setVisible(true);
            }
        });
    }
